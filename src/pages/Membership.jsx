    ...
    <>
      ...
      <FadeInSection>
        ...
        >
          ...
          invitation to a refined way of living. With tiered memberships
          designed for different lifestyles, each member enjoys exclusive
          spaces, curated events, and a community of like-minded individuals who
          value privacy, purpose, and elevated experiences.
        </p>
      </FadeInSection>
      <FadeInSection>
        <div
        ...
        >
          <div className="row">
            ...
            <div className="col border membership-box">
              ...
              <br />
              <p>
                Bulk membership for 5+ employees; shared workspace + event
                access
              </p>
              <br />
              <h6>
            ...
            <div className="col border membership-box">
              ...
              <br />
              <p>
                Includes Full + access to overnight suites or partnered houses
                (4 free stays/year)
              </p>
              <br />
              <h6>
